...
class ApplicationMain
{
	...
	public static function main()
	{
		...
		lime.system.System.embed("MyApplication", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["name"] = "Kareshi Project";
		app.meta["packageName"] = "com.brenninho.kareshi";
		...
		#elseif air
		app.window.title = "Kareshi Project";
		#else
